...
if(isset($_POST['Confirm_request'])){ //check if form was submitted
	...
	{
		$sql="INSERT INTO request_loan (FullName,Email,Mobile_Phone,National_ID, Address,Job,Status,Amount,Salary,HR_letter) 
		values 
		(
		'".$_SESSION['FullName']."',
		'".$_SESSION['Email']."',
		...
		if($result)	
		{
			echo "<script>"."alert('Your request has been delivered. Thank you!!!')"."</script>";
...
<h3>Upload a copy of your National ID please</h3>
